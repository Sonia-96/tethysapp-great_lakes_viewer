...
To run tests for an app:
    ...
    2. In portal_config.yml make sure that the default database user is set to
       tethys_super or is a super user of the database
        DATABASES:
            default:
...
class GreatLakesViewerTestCase(TethysTestCase):
    ...
    def set_up(self):
        ...
        test database creation function here, like so:
            ...
            self.create_test_persistent_stores_for_app(GreatLakesViewer)
    ...
    def tear_down(self):
        ...
        stores, you should call the test database destruction function from here, like so:
            ...
            self.destroy_test_persistent_stores_for_app(GreatLakesViewer)
    ...
    def test_home_controller(self):
        ...
        response = c.get('/apps/great-lakes-viewer/')  # The final '/' is essential for all pages/controllers
